<?php
define('TWENTYTEN_XILI_VER', '1.6.1'); // as style.css
/**
...
function twentyten_xilidev_setup () {
	...
	// Args dedicaced to this theme named TwentyTen
		...
		if ( $class_ok ) {
			...
			<div class="error">'.
				/* translators: added in child functions by xili */
				'<p>' . sprintf ( __('The %s child theme requires xili_language_theme_options class installed and activated', 'twentyten' ), get_option( 'current_theme' ) ).'</p>
			</div>';
